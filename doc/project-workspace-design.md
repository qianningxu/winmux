...
Tab widths retain the existing native calculation and 200-point upper limit; the prototype’s 100–160-point clamp is intentionally not applied. Content is left aligned. Spacing is four points; individual group shells do not add another horizontal or bottom inset to the tiling gap. Project and workspace tabs each occupy a 40-point row with 32-point selections and four points above/below.
