...
Tab widths retain the existing native calculation and 200-point upper limit. Content is left aligned. The Project menu and workspace tabs share one first-row border. Both navigation rows are 40 points tall with 32-point tabs and four points above and below. Workspace window tab bars also use two points at their leading and trailing ends. Workspace windows use six-point structural gaps.
