...
let subcommandDescriptions = [
    ...
    ["  folder", "Focus the specified sidebar folder"],
    ...
    ["  move-node-to-folder", "Move the focused window to the specified sidebar folder"],
    ["  move-node-to-project", "Legacy alias for move-node-to-folder"],
    ...
    ["  project", "Legacy alias for folder"],
    ...
    ["  stack-with", "Disabled legacy center stacking command"],
